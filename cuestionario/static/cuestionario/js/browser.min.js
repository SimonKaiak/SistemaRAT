 ...
 * -------------------------------------------
 * Librería utilitaria para detección de navegador, sistema operativo
 * y capacidades del dispositivo. Parte de la plantilla Hyperspace
 * de HTML5 UP.
 *
 * Propiedades disponibles en el objeto global `browser`:
 *   browser.name       → Nombre del navegador detectado
 *                        (firefox, chrome, safari, edge, opera,
 *                        ie, bb, other).
 *   browser.version    → Versión numérica del navegador.
 *   browser.os         → Sistema operativo detectado
 *                        (ios, android, wp, mac, windows, linux,
 *                        bsd, unix, bb, other).
 *   browser.osVersion  → Versión numérica del SO.
 *   browser.touch      → true si el dispositivo tiene pantalla táctil.
 *   browser.mobile     → true si es un dispositivo móvil
 *                        (ios, android, wp, bb).
 *
 * Método:
 *   browser.canUse(prop) → true si el navegador soporta la propiedad
 *                          CSS indicada (verifica prefijos Moz,
 *                          Webkit, O, ms).
 *
 * Nota: detecta iPads con touch en macOS y los reclasifica como iOS.
 */
/* browser.js v1.0.1 | @ajlkn | MIT licensed */
